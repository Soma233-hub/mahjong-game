...
## 次回作業内容（第4週）
- Yaku.js の全役実装
  - フェーズA 基本役: タンヤオ・ピンフ・一盃口・トイトイ・七対子・ツモ・リーチ
  - フェーズB 役牌・特殊役: 白・發・中・場風・自風・嶺上・槍槓・ハイテイ・ホウテイ
  - フェーズC 複合役: 三色同順・一気通貫・チャンタ・純チャン・混一色・清一色・三暗刻等
  - フェーズD 役満: 国士・四暗刻・大三元・大四喜・小四喜・字一色・緑一色・九連・四槓子・天和・地和
- Hand.isComplete() 実装（14枚+副露での和了形チェック）
- Game._canRon に役チェックを統合（役なし=ロン不可）
- processWin に役リスト付与
- tests/test-yaku.js 作成（全役テスト・エッジケース網羅）
